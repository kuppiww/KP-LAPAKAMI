...
namespace Modules\ReqSKCK\Http\Controllers;
...
use Modules\ReqSKCK\Repositories\SKCKRepository;
...
class ReqSKCKController extends Controller
{
    public function __construct(){
        ...
        $this->_skckRepository              = new SKCKRepository;
    ...
    public function create(Request $request)
    {
        ...
        return view('reqskck::create',  compact('user', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->_skckRepository->insert(DataHelper::_normalizeParams($request->all(), true));
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->_skckRepository->update(DataHelper::_normalizeParams($request->all(), false, true), $id);
