...
class SysModuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('sysmodule')->with('message', 'Module berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('sysmodule')->with('message', 'Module berhasil diubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('sysmodule')->with('message', 'Module berhasil dihapus');
    }
    ...
    private function _validationRules($id='')
    {
        if ($id == '') {
            return [
                'module_id' => 'required|unique:sys_modules',
            ];  
           
        }else{
            return [
                'module_id' => 'required|unique:sys_modules,module_id,' . $id . ',module_id',
            ];  
        }
