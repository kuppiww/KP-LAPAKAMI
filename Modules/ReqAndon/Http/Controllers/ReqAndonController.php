...
namespace Modules\ReqAndon\Http\Controllers;
...
use Modules\ReqAndon\Repositories\ReqAndonRepository;

use App\Helpers\DataHelper;
use App\Helpers\LogHelper;
use DB;

class ReqAndonController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('reqandon::create',  compact('user', 'sub_districts', 'districts', 'religions', 'genders', 'attach_samples'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->_reqAndonRepository->insert(DataHelper::_normalizeParams($request->all(), true));
        ...
        if($req_id != null){
            $data_email   = array(
                ...
                'url'           => env('APP_URL').'/user/layanan/andon-nikah/lihat/'.$req_id,
                'service_name'  => 'Surat Keterangan Andon Nikah',
    ...
    public function show(Request $request, $id)
    {
        ...
        $request_detail  = $this->_reqAndonRepository->getByParams($filter); 

        return view('reqandon::detail', compact ('request', 'request_detail', 'logs', 'request_docs'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('reqandon::edit', compact ('request', 'request_detail', 'logs', 'request_docs', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->_reqAndonRepository->update(DataHelper::_normalizeParams($request->all(), false, true), $id);
    ...
    private function _uploadFile($request)
    {
        ...
        if ($request->file('f_ktp') != '') {
            ...
            $request->file("f_ktp")->storeAs('files/request_andon/ktp', $imageName, 'public');
        ...
        if ($request->file('f_p_rt_rw') != '') {
            ...
            $request->file("f_p_rt_rw")->storeAs('files/request_andon/pengantar_rt_rw', $imageName, 'public');
        ...
        if ($request->file('f_kk') != '') {
            ...
            $request->file("f_kk")->storeAs('files/request_andon/kk', $imageName, 'public');
