...
<div class="card p-2 border-0">
	<div class="card-body">
		...
		<form id="createForm" method="POST" action="/user/layanan/andon-nikah/buat" enctype="multipart/form-data">
			@csrf
			<!-- Form 1 -->
			<h3>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-12 mt-4"><h5>Informasi Pasangan</h5></div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Nama Pasangan<span class="text-danger">*</span></label>
							<input type="text" name="nama_pasangan" class="form-control" placeholder="Masukan nama pasangan">
						</div>
						<div class="col-md-12 mb-3 form-group">
							<label class="form-label">Alamat Pasangan<span class="text-danger">*</span></label>
							<textarea class="form-control" name="alamat_pasangan" placeholder="Tulis alamat pasangan disini" name="alamat pasangan"></textarea>
						</div>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Kartu Tanda Penduduk (KTP) Calon Pengantin Pria/Wanita<span class="text-danger">*</span></label>
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Kartu Keluarga (KK) Calon Pengantin Pria/Wanita<span class="text-danger">*</span></label>
