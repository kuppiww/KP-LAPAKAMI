...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/izin-keramaian/buat" enctype="multipart/form-data">
                @csrf
                <!-- Form 1 -->
                <h3>
                    ...
                    <div class="fieldset-content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="tgl_kegiatan" class="form-control datepicker_activity"
                                        placeholder="dd/mm/yyyy">
                                    <span class="input-group-text" id="basic-addon2"><i
                                            class="ri-calendar-line"></i></span>
                                </div>
                            ...
                            <div class="col-md-6 mb-3 d-none form-group" id="moreday">
                                ...
                                <div class="input-group">
                                    <input type="text" name="tgl_kegiatan_akhir" class="form-control datepicker_activity"
                                        placeholder="dd/mm/yyyy">
                                    <span class="input-group-text" id="basic-addon2"><i
                                            class="ri-calendar-line"></i></span>
                                </div>
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Surat Pemberitahuan Tetangga</label>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Surat Keterangan Panitia</label>
