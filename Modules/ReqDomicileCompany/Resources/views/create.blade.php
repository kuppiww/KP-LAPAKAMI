...
<div class="card p-2 border-0">
	<div class="card-body">
		...
		<form id="createForm" method="POST" action="/user/layanan/domisili-perusahaan/buat" enctype="multipart/form-data">
			@csrf
			<!-- Form 1 -->
			<h3>
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<!-- <div class="col-md-6 mb-3 form-group">
							...
							<div class="input-group">
								<input type="text" name="masa_berlaku" class="form-control datepicker" placeholder="dd/mm/yyyy">
								<span class="input-group-text" id="basic-addon2"><i class="ri-calendar-line"></i></span>
							</div>
						</div> -->

						<div class="col-md-12 mt-4 "><h5>Informasi Perusahaan</h5></div>
						<div class="col-md-12 mb-3 form-group">
							<label class="form-label">Nama Perusahaan<span class="text-danger">*</span></label>
							<input type="text" name="nama_perusahaan" class="form-control" placeholder="Masukan nama perusahaan">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Jenis Usaha<span class="text-danger">*</span></label>
							<input type="text" name="jenis_usaha" class="form-control" placeholder="Masukan jenis usaha">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Notaris<span class="text-danger">*</span></label>
							<input type="text" name="notaris" class="form-control" placeholder="Masukan notaris">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">No. Akta Notaris<span class="text-danger">*</span></label>
							<input type="text" name="no_akta_notaris" class="form-control" placeholder="Masukan nomor akta notaris">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Tanggal Akta Notaris<span class="text-danger">*</span></label>
							<div class="input-group">
								<input type="text" name="tgl_akta_notaris" class="form-control datepicker" placeholder="dd/mm/yyyy">
								<span class="input-group-text" id="basic-addon2"><i class="ri-calendar-line"></i></span>
							</div>
						</div>
						<div class="col-md-6 mb-3 form-group">
							...
							<div class="input-group">
								<input type="text" name="jml_karyawan" class="form-control" placeholder="Masukan jumlah karyawan">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="jam_kerja" class="form-control" placeholder="Masukan jam kerja">
						</div>
						<div class="col-md-12 mb-3 form-group">
							<label class="form-label">Alamat Usaha<span class="text-danger">*</span></label>
							<textarea class="form-control" placeholder="Tulis alamat usaha disini" name="alamat"></textarea>
						</div>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Akta Pendirian Perusahaan/Akta Notaris Perusahaan/SK-KEMENKUMHAM<span class="text-danger">*</span></label>
							<input type="file" name="f_pendirian" class="form-control" placeholder="Masukan akta pendirian perusahaan">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="file" name="f_p_rt_rw" class="form-control" placeholder="Masukan surat pengantar">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Sewa Penyewa/Bukti Kepemilikan Tempat<span class="text-danger">*</span></label>
							<input type="file" name="f_sewa_kepemilikan" class="form-control" placeholder="Masukan bukti sewa">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Surat Keterangan Tidak Keberatan Tanah/Rumah Dipakai Usaha</label>
							<input type="file" name="f_keterangan_rumah" class="form-control" placeholder="Masukan surat keterangan tidak keberatan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
        ...
        (function($) {
            ...
            form.validate({
                ...
                messages: {
					...
					f_pendirian :{
						required: "Akta pendirian tidak boleh kosong",
						extension: "Hanya boleh mengunggah .pdf, .jpeg, .png",
                        filesize: "Ukuran file maksimal 5MB"
					},
					f_p_rt_rw:{
						required: "Surat Pengantar RT RW tidak boleh kosong",
						extension: "Hanya boleh mengunggah .pdf, .jpeg, .png",
                        filesize: "Ukuran file maksimal 1MB"
					},
					f_sewa_kepemilikan : {
						required: "Sewa penyewa/bukti kepemilikan tempat tidak boleh kosong",
						extension: "Hanya boleh mengunggah .pdf, .jpeg, .png",
                        filesize: "Ukuran file maksimal 1MB"
					},
					f_keterangan_rumah : {
