...
<div class="row mb-4 align-items-center">
	...
	<div class="col-md-6 text-md-end">
		@if ($request->request_status_id == 'SUBMITED' || $request->request_status_id == 'REJECTED')
			<a href="/user/layanan/domisili-perusahaan/ubah/{{ $request->request_id }}" class="btn btn-warning">
				<i class="ri-pencil-line me-2"></i> Ubah Permohonan
			</a>
		@endif
		@if ($request->request_status_id == 'SUBMITED')
			<a href="javascript:void(0)" data-url="/user/layanan/domisili-perusahaan/batal/{{ $request->request_id }}" class="btn btn-danger btnCancelReq">
					...
					<!-- Tab 2. Informasi Layanan -->
				  	<div class="tab-pane fade" id="pills-service" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
				  		<div class="row">
							...
							<!-- <div class="col-md-6">
				  				<p>
				  					<label class="form-label">Masa Berlaku</label><br>
									{{$request_detail->masa_berlaku}}
				  				</p>
				  			</div> -->
							  <div class="col-md-12 mb-3">
								<h5 class="text-dark">Informasi Perusahaan</h5>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Nama Perusahaan</label><br>
								  {{$request_detail->nama_perusahaan}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
								  <label class="form-label">Jenis Usaha</label><br>
								  {{$request_detail->jenis_usaha}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Jumlah Karyawan</label><br>
								  {{$request_detail->jml_karyawan}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Jam Kerja</label><br>
								  {{$request_detail->jam_kerja}}
								</p>
							</div>
							<div class="col-md-12">
								<p>
									<label class="form-label">Alamat Usaha</label><br>
								  {{$request_detail->alamat}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Notaris</label><br>
								  {{$request_detail->notaris}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">No. Akta Notaris</label><br>
								  {{$request_detail->no_akta_notaris}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Tanggal Akta Notaris</label><br>
									{{ DateFormatHelper::dateInFull($request_detail->tgl_akta_notaris) }}
								</p>
							</div>
							<div class="col-md-6">
								<p>
								...
								<div class="col-md-6">
									<p>
										@if ($request_doc->request_attachment_note == "FILE_KTP")
											...
											<a href="javascript:void(0)" data-title="Kartu Tanda Penduduk (KTP)" data-src="/storage/files/request_company/ktp/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> KTP</a>
										@elseif ($request_doc->request_attachment_note == "FILE_RT_RW")
											<label class="form-label">Surat Pengantar RT/RW</label><br>
											<a href="javascript:void(0)" data-title="Surat Pengantar RT/RW" data-src="/storage/files/request_company/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat Pengantar</a>
										@elseif ($request_doc->request_attachment_note == "FILE_PENDIRIAN")
											<label class="form-label">Akta Pendirian Perusahaan/SK-KEMENKUMHAM</label><br>
											<a href="javascript:void(0)" data-title="Akta Pendirian Perusahaan" data-src="/storage/files/request_company/pendirian/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Akta Pendirian Perusahaan</a>
										@elseif ($request_doc->request_attachment_note == "FILE_SEWA_KEPEMILIKAN")
											<label class="form-label">Sewa Penyewa/Bukti Kepemilikan Tempat</label><br>
											<a href="javascript:void(0)" data-title="Sewa Penyewa/Bukti Kepemilikan Tempat" data-src="/storage/files/request_company/sewa_kepemilikan/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Sewa Penyewa/Bukti Kepemilikan Tempat</a>
										@elseif ($request_doc->request_attachment_note == "FILE_KETERANGAN_RUMAH")
											<label class="form-label">Surat Keterangan Tidak Keberatan Tanah/Rumah Dipakai Usaha</label><br>
											<a href="javascript:void(0)" data-title="Surat Keterangan Tidak Keberatan Tanah/Rumah Dipakai Usaha" data-src="/storage/files/request_company/keterangan_rumah/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Sewa Penyewa/Bukti Kepemilikan Tempat</a>
										@endif
									</p>
								</div>
							@endforeach
	...
	<div class="col-md-4">
		<div class="card p-2 border-0 mb-4">
			<div class="card-body">
				...
				@if ($request->request_status_id == 'APPROVED_KEC')
					<!-- Available -->
