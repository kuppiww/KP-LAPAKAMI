...
<div class="card p-2 border-0">
	<div class="card-body">
		...
		<form id="createForm" method="POST" action="/user/layanan/bersih-diri/update/{{$request->request_id}}" enctype="multipart/form-data">
			@csrf
			<!-- Form 1 -->
			<h3>
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan nama lengkap" value="{{$request->nama_warga}}" disabled="disabled">
						</div>
						<div class="col-md-6 mb-3 form-group">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="" class="form-control"
								value="{{ $request->pekerjaan }}" placeholder="Masukan pekerjaan" readonly>
						</div>
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="nik_ayah" class="form-control" value="{{$request_detail->nik_ayah}}"
							placeholder="Masukan nomor induk kependudukan">
						</div>
						
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Nama Ayah/Wali<span class="text-danger">*</span></label>
							<input type="text" name="nama_ayah" class="form-control"  value="{{$request_detail->nama_ayah}}"
							placeholder="Masukan nama lengkap">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Pekerjaan Ayah/Wali<span class="text-danger">*</span></label>
							<input type="text" name="pekerjaan_ayah" class="form-control"  value="{{$request_detail->pekerjaan_ayah}}"
                                    placeholder="Masukan pekerjaan">
						</div>
                        <div class="col-md-6 mb-3 form-group">
                            <label class="form-label">Agama Ayah/Wali</label>
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="nik_ibu" class="form-control" value="{{$request_detail->nik_ibu}}"
                                    placeholder="Masukan nomor induk kependudukan">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Nama Ibu/Wali<span class="text-danger">*</span></label>
							<input type="text" name="nama_ibu" class="form-control" value="{{$request_detail->nama_ibu}}"
                                    placeholder="Masukan nama lengkap">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Pekerjaan Ibu/Wali<span class="text-danger">*</span></label>
							<input type="text" name="pekerjaan_ibu" class="form-control" value="{{$request_detail->pekerjaan_ibu}}"
							placeholder="Masukan pekerjaan">
						</div>
						<div class="col-md-6 mb-3 form-group">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="no_surat_pengantar" class="form-control" value="{{$request->no_surat_pengantar}}"
                                    placeholder="Masukan nomor surat">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Tanggal Surat<span class="text-danger">*</span></label>
							<div class="input-group">
								<input type="text" name="tgl_surat_pengantar" class="form-control datepicker" value="{{DateFormatHelper::dateNum($request->tgl_surat_pengantar)}}"
								placeholder="dd/mm/yyyy">
						...
						<div class="col-md-12 mb-3 form-group">
							...
							<input type="text" name="keperluan" value="{{$request_detail->keperluan}}" class="form-control" placeholder="Masukan keperluaan">
						</div>
                	...
                	<div class="row">
						<div class="col-md-6 mb-3">
                            ...
                            @foreach ($request_docs as $request_doc)
                                @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                    <a href="/storage/files/request_clean/ktp/{{ $request_doc->request_attachment_file }}" target="_blank"
							...
							<label class="form-label">Kartu Keluarga<span class="text-danger">*</span>
                                @foreach ($request_docs as $request_doc)
                                    @if ($request_doc->request_attachment_note == 'FILE_KK')
                                        <a href="/storage/files/request_clean/kk/{{ $request_doc->request_attachment_file }}" target="_blank"
                                            class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                            <i class="ri-arrow-right-up-line"></i> Lihat File
                                        </a>
                                    @endif
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Surat Pengantar RT/RW<span class="text-danger">*</span>  
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KK')
                                            <a href="/storage/files/request_clean/pengantar_rt_rw/{{ $request_doc->request_attachment_file }}" target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
