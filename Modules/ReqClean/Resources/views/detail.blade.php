    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end">
            ...
            @if ($request->request_status_id == 'SUBMITED' || $request->request_status_id == 'REJECTED')
                <a href="/user/layanan/bersih-diri/ubah/{{ $request->request_id }}" class="btn btn-warning me-2">
                    <i class="ri-pencil-line me-2"></i>Ubah Permohonan
                </a>
                <a href="javascript:void(0)" data-url="/user/layanan/bersih-diri/batal/{{ $request->request_id }}" class="btn btn-danger btnCancelReq">
                                    ...
                                    <div class="col-md-6">
                                        <p>
                                            @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                                ...
                                                <a href="javascript:void(0)" data-title="Surat Pengantar RT/RW" data-src="/storage/files/request_clean/pengantar_rt_rw/{{ $request_doc->request_attachment_file }}" 
                                                    class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat
                                                    pengantar</a>
                                            @elseif ($request_doc->request_attachment_note == 'FILE_KK')
                                                <label class="form-label">Kartu Keluarga</label><br>
                                                <a href="javascript:void(0)" data-title="Kartu Keluarga" data-src="/storage/files/request_clean/kk/{{ $request_doc->request_attachment_file }}"
                                                    class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Kartu
                                                    Keluarga</a>
                                            @elseif ($request_doc->request_attachment_note == 'FILE_KTP')
                                                <label class="form-label">Kartu Tanda Penduduk (KTP)</label><br>
                                                <a href="javascript:void(0)" data-title="Kartu Tanda Penduduk (KTP)" data-src="/storage/files/request_clean/ktp/{{ $request_doc->request_attachment_file }}"
                                                    class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> KTP
                                                    </a>
                                           @endif
                                        </p>
                                    </div>
