...
namespace Modules\ReqClean\Http\Controllers;
...
use Modules\ReqClean\Repositories\ReqCleanRepository;
...
class ReqCleanController extends Controller
{
    public function __construct(){
        ...
        $this->_reqCleanRepository          = new ReqCleanRepository;
    ...
    public function create(Request $request)
    {
        ...
        return view('reqclean::create', compact('user', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    }
    ...
    public function store(Request $request)
    {
       ...
       $this->_reqCleanRepository->insert(DataHelper::_normalizeParams($request->all(), true));
       ...
       if($req_id != null){
            $data_email   = array(
                ...
                'url'           => env('APP_URL').'/user/layanan/bersih-diri/lihat/'.$req_id,
                'service_name'  => 'Surat Keterangan Bersih Diri',
    ...
    public function show(Request $request, $id)
    {
        ...
        $request_detail  = $this->_reqCleanRepository->getByParams($filter); 
 
        return view('reqclean::detail', compact ('request', 'request_detail', 'logs', 'request_docs'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('reqclean::edit', compact ('request', 'request_detail', 'logs', 'request_docs', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    ...
    public function update(Request $request, $id)
    {
       ...
       $request['tgl_surat_pengantar'] = date("Y-m-d", strtotime($tgl_surat_pengantar));
        ...
        $this->_reqCleanRepository->update(DataHelper::_normalizeParams($request->all(), false, true), $id);
    ...
    private function _uploadFile($request)
    {
        ...
        if ($request->file('f_ktp') != '') {
            ...
            $request->file("f_ktp")->storeAs('files/request_clean/ktp', $imageName, 'public');
        ...
        if ($request->file('f_p_rt_rw') != '') {
            ...
            $request->file("f_p_rt_rw")->storeAs('files/request_clean/pengantar_rt_rw', $imageName, 'public');
        ...
        if ($request->file('f_kk') != '') {
            ...
            $request->file("f_kk")->storeAs('files/request_clean/kk', $imageName, 'public');
