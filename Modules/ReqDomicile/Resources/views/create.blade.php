...
<div class="row mb-4 align-items-center">
	<div class="col-md-12">
		...
		<p class="mb-0 text-muted">Surat Keterangan Domisili</p>
	</div>
</div>
...
<div class="card p-2 border-0">
	<div class="card-body">
		...
		<form id="createForm" method="POST" action="/user/layanan/domisili/buat" enctype="multipart/form-data">
			@csrf
			<!-- Form 1 -->
			<h3>
                	...
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							<div class="form-group">
								...
								<input type="text" name="kewarganegaraan" class="form-control" value="{{ $user->user_kewarganegaraan }}"
									placeholder="Masukan kewarganegaraan" disabled="disabled">
							</div>
						</div>
						<div class="col-md-6 mb-3 form-group">
							<div class="form-group">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
                		<div class="col-md-12 mt-4"><h5>Informasi Surat Pengantar RT/RW</h5></div>
						...
						<div class="col-md-12 mt-4"><h5>Informasi Yayasan/Lembaga/Organisasi</h5></div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Nama Yayasan/Lembaga/Organisasi<span class="text-danger">*</span></label>
							<input type="text" name="nama_organisasi" class="form-control" placeholder="Masukan nama yayasan/lembaga/organisasi">
						</div>
						<div class="col-md-6 mb-3 form-group">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<div class="input-group">
								<input type="text" name="jumlah_anggota" class="form-control" placeholder="Masukan jumlah karyawan">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Akta Pendirian/SK-KEMENKUMHAM Yayasan/Lembaga/Organisasi<span class="text-danger">*</span></label>
							<input type="file" name="f_pendirian" class="form-control" placeholder="Masukan akta pendirian">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="file" name="f_denah" class="form-control" placeholder="Masukan denah lokasi">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            form.validate({
                ...
                messages: {
                    nama_organisasi: "Nama organisasi tidak boleh kosong",
