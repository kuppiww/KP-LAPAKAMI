...
<div class="row mb-4 align-items-center">
	...
	<div class="col-md-6 text-md-end">
		@if ($request->request_status_id == 'SUBMITED' || $request->request_status_id == 'REJECTED')
			<a href="/user/layanan/domisili/ubah/{{ $request->request_id }}" class="btn btn-warning">
				<i class="ri-pencil-line me-2"></i> Ubah Permohonan
			</a>
		@endif
		@if ($request->request_status_id == 'SUBMITED')
			<a href="javascript:void(0)" data-url="/user/layanan/domisili/batal/{{ $request->request_id }}" class="btn btn-danger btnCancelReq">
				  		...
				  		<div class="row">
				  			...
				  			<div class="col-md-6">
				  				<p>
				  					...
				  					{{$request_detail->kewarganegaraan}}
				  				</p>
				  			</div>
				  			<div class="col-md-6">
				  				<p>
					...
					<!-- Tab 2. Informasi Layanan -->
				  	<div class="tab-pane fade" id="pills-service" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
				  		<div class="row">
							  ...
							  <div class="col-md-12 mb-3">
								<h5 class="text-dark">Informasi Yayasan/Lembaga/Organisasi</h5>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Nama Yayasan/Lembaga/Organisasi</label><br>
								  {{$request_detail->nama_organisasi}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
							...
							<div class="col-md-6">
								<p>
									<label class="form-label">Jumlah Anggota</label><br>
								  {{$request_detail->jumlah_anggota}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
								...
								<div class="col-md-6">
									<p>
										@if ($request_doc->request_attachment_note == "FILE_KTP")
											...
											<a href="javascript:void(0)" data-title="Kartu Tanda Penduduk (KTP)" data-src="/storage/files/request_domicile/ktp/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> KTP</a>
										@elseif ($request_doc->request_attachment_note == "FILE_RT_RW")
											<label class="form-label">Surat Pengantar RT/RW</label><br>
											<a href="javascript:void(0)" data-title="Surat Pengantar RT/RW" data-src="/storage/files/request_domicile/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat Pengantar</a>
										@elseif ($request_doc->request_attachment_note == "FILE_PENDIRIAN")
											<label class="form-label">Akta Pendirian/SK-KEMENKUMHAM Yayasan/Lembaga/Organisasi</label><br>
											<a href="javascript:void(0)" data-title="Akta Pendirian Yayasan/Lembaga/Organisasi" data-src="/storage/files/request_domicile/pendirian/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Akta Pendirian Yayasan/Lembaga/Organisasi</a>
										@elseif ($request_doc->request_attachment_note == "FILE_SEWA_KEPEMILIKAN")
											...
											<a href="javascript:void(0)" data-title="Sewa Penyewa/Bukti Kepemilikan Tempat" data-src="/storage/files/request_domicile/sewa_kepemilikan/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Sewa Penyewa/Bukti Kepemilikan Tempat</a>
										@elseif ($request_doc->request_attachment_note == "FILE_DENAH")
											<label class="form-label">Denah Lokasi</label><br>
											<a href="javascript:void(0)" data-title="Denah Lokasi" data-src="/storage/files/request_domicile/denah/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Denah Lokasi</a>
										@endif
									</p>
								</div>
							@endforeach
