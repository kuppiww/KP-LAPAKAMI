...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/domisili/update/{{ $request->request_id }}"
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-4">
                                <h5>Informasi Yayasan/Lembaga/Organisasi</h5>
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Nama Yayasan/Lembaga/Organisasi<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="nama_organisasi"
                                    value="{{ $request_detail->nama_organisasi }}" class="form-control"
                                    placeholder="Masukan nama yayasan/lembaga/organisasi">
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="jumlah_anggota"
                                        value="{{ $request_detail->jumlah_anggota }}" class="form-control"
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                                ...
                                <label class="form-label">Kartu Tanda Penduduk (KTP)<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                            <a href="/storage/files/request_domicile/ktp/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Akta Pendirian/SK-KEMENKUMHAM Yayasan/Lembaga/Organisasi<span
                                        class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_PENDIRIAN')
                                            <a href="/storage/files/request_domicile/pendirian/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <input type="file" name="f_pendirian" class="form-control"
                                    placeholder="Masukan akta pendirian">
                                ...
                                <label class="form-label">Surat Pengantar RT/RW<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                            <a href="/storage/files/request_domicile/pengantar_rt_rw/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <label class="form-label">Sewa Penyewa/Bukti Kepemilikan Tempat<span
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_SEWA_KEPEMILIKAN')
                                            <a href="/storage/files/request_domicile/sewa_kepemilkan/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Denah Lokasi
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_DENAH')
                                            <a href="/storage/files/request_domicile/denah/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <input type="file" name="f_denah" class="form-control"
                                    placeholder="Masukan denah lokasi">
                                <small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
                            </div>
