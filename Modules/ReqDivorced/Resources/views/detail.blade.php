...
<div class="row mb-4 align-items-center">
	...
	<div class="col-md-6 text-md-end">
		@if ($request->request_status_id == 'SUBMITED' || $request->request_status_id == 'REJECTED')
			<a href="/user/layanan/janda-duda/ubah/{{ $request->request_id }}" class="btn btn-warning">
				<i class="ri-pencil-line me-2"></i> Ubah Permohonan
			</a>
		@endif
		@if ($request->request_status_id == 'SUBMITED')
			<a href="javascript:void(0)" data-url="/user/layanan/janda-duda/batal/{{ $request->request_id }}" class="btn btn-danger btnCancelReq">
					...
					<!-- Tab 2. Informasi Layanan -->
				  	<div class="tab-pane fade" id="pills-service" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
				  		<div class="row">
							...
							<div class="col-md-6">
								<p>
									<label class="form-label">Status Janda/Duda</label><br>
								  {{$request_detail->widow_status}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
								  <label class="form-label">Sebab Janda/Duda</label><br>
								  {{$request_detail->ket}}
								</p>
							</div>
							<div class="col-md-6">
								...
								<div class="col-md-6">
									<p>
										@if ($request_doc->request_attachment_note == "FILE_KTP")
											...
											<a href="javascript:void(0)" data-title="Kartu Tanda Penduduk (KTP)" data-src="/storage/files/request_devorced/ktp/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> KTP</a>
										@elseif ($request_doc->request_attachment_note == "FILE_RT_RW")
											<label class="form-label">Surat Pengantar RT/RW</label><br>
											<a href="javascript:void(0)" data-title="Surat Pengantar RT/RW" data-src="/storage/files/request_devorced/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat Pengantar</a>
										@elseif ($request_doc->request_attachment_note == "FILE_KK")
											<label class="form-label">Kartu Keluarga</label><br>
											<a href="javascript:void(0)" data-title="Kartu Keluarga" data-src="/storage/files/request_devorced/kk/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Kartu Keluarga</a>
										@elseif ($request_doc->request_attachment_note == "FILE_AKTA_CERAI")
											<label class="form-label">Akta Cerai/Akta Kematian Suami/Istri</label><br>
											<a href="javascript:void(0)" data-title="Akta Cerai/Akta Kematian Suami/Istri" data-src="/storage/files/request_devorced/akta_cerai/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Akta Cerai/Akta Kematian Suami/Istri</a>
										@elseif ($request_doc->request_attachment_note == "FILE_SPTJM")
											<label class="form-label">Surat Dibawah Tangan/SPTJM (bagi pemohon untuk nikah siri)</label><br>
											<a href="javascript:void(0)" data-title="Surat Dibawah Tangan/SPTJM)" data-src="/storage/files/request_devorced/sptjm/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i>Surat Dibawah Tangan/SPTJM (bagi pemohon untuk nikah siri)</a>
										@endif
									</p>
								</div>
							@endforeach
