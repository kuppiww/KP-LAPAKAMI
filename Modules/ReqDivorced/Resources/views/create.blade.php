...
<div class="card p-2 border-0">
	<div class="card-body">
		...
		<form id="createForm" method="POST" action="/user/layanan/janda-duda/buat" enctype="multipart/form-data">
			@csrf
			<!-- Form 1 -->
			<h3>
                ...
                <div class="fieldset-content">
                	<div class="row">
									...
									@if (sizeof($widow_stats) > 0)
										@foreach ($widow_stats as $widow_stat)
											<option value="{{ $widow_stat->id_widow_status }}"
												{{ $user->kd_kel == $widow_stat->id_widow_status ? 'selected' : '' }}>
									...
									@if (sizeof($widow_kets) > 0)
										@foreach ($widow_kets as $widow_ket)
											<option value="{{ $widow_ket->id_ket }}"
												{{ $user->kd_kel == $widow_ket->id_ket ? 'selected' : '' }}>
						...
						<div class="col-md-12 mb-3 form-group">
							...
							<input type="text" name="perihal" class="form-control" placeholder="Masukan keperluan">
						</div>
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="file" name="f_kk" class="form-control" placeholder="Masukan KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Akta Cerai/Akta Kematian Suami/Istri<span class="text-danger">*</span></label>
							<input type="file" name="f_akta_cerai" class="form-control" placeholder="Masukan akta cerai">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Surat Dibawah Tangan/SPTJM (bagi pemohon untuk nikah siri)</label>
							<input type="file" name="f_sptjm" class="form-control" placeholder="Masukan surat dibawah tangan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
	...
	(function($) {
		...
		form.validate({
			...
			messages: {
				...
				f_akta_cerai : {
					required: "Akta cerai tidak boleh kosong",
					extension: "Hanya boleh mengunggah .pdf, .jpeg, .png",
					filesize: "Ukuran file maksimal 1MB"
				},
				f_sptjm : {
