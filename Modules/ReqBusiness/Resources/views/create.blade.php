...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/mempunyai-usaha/buat" enctype="multipart/form-data">
                @csrf
                <!-- Form 1 -->
                <h3>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kewarganegaraan" class="form-control"
                                        value="{{ $user->user_kewarganegaraan }}" placeholder="Masukan kewarganegaraan"
                                        disabled="disabled">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                    ...
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="form-group">
                                    <label class="form-label">Rukun Tetangga (RT)<span
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label">Keperluan Kredit Ke-<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="kredit_ke" class="form-control" placeholder="Bank">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat_usaha" placeholder="Tulis alamat usaha disini"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Foto Usaha<span class="text-danger">*</span></label>
        ...
        (function($) {
            ...
            form.validate({
                ...
                messages: {
                    ...
                    f_usaha: {
                        required: "Foto usaha tidak boleh kosong",
                        extension: "Hanya boleh mengunggah .pdf, .jpeg, .png",
                        filesize: "Ukuran file maksimal 1MB"
                    }
                },
