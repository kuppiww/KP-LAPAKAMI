...
<div class="row mb-4 align-items-center">
	...
	<div class="col-md-6 text-md-end">
		@if ($request->request_status_id == 'SUBMITED' || $request->request_status_id == 'REJECTED')
			<a href="/user/layanan/mempunyai-usaha/ubah/{{ $request->request_id }}" class="btn btn-warning">
				<i class="ri-pencil-line me-2"></i> Ubah Permohonan
			</a>
		@endif
		@if ($request->request_status_id == 'SUBMITED')
			<a href="javascript:void(0)" data-url="/user/layanan/mempunyai-usaha/batal/{{ $request->request_id }}" class="btn btn-danger btnCancelReq">
				  		...
				  		<div class="row">
				  			...
				  			<div class="col-md-6">
				  				<p>
									...
									{{ DateFormatHelper::dateIn($request_detail->masa_berlaku) }}
				  				</p>
				  			</div>

							  <div class="col-md-12 mb-3">
								<h5 class="text-dark">Informasi Usaha</h5>
							</div>
							<div class="col-md-6">
								<p>
							...
							<div class="col-md-6">
								<p>
									<label class="form-label">NPWP</label><br>
								  {{$request_detail->npwp}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Keperluan kredit ke</label><br>
								  {{$request_detail->kredit_ke}}
								</p>
							</div>
							<div class="col-md-6">
								<p>
									<label class="form-label">Tanggal Surat Pernyataan</label><br>
									{{ DateFormatHelper::dateIn($request_detail->tgl_surat_pernyataan) }}
								</p>
							</div>
							<div class="col-md-12">
								<p>
									<label class="form-label">Alamat Usaha</label><br>
									{{$request_detail->alamat_usaha }}
								</p>
							</div>
								...
								<div class="col-md-6">
									<p>
										@if ($request_doc->request_attachment_note == "FILE_KTP")
											...
											<a href="javascript:void(0)" data-title="Kartu Tanda Penduduk (KTP)" data-src="/storage/files/request_business/ktp/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> KTP</a>
										@elseif ($request_doc->request_attachment_note == "FILE_RT_RW")
											<label class="form-label">Surat Pengantar RT/RW</label><br>
											<a href="javascript:void(0)" data-title="Surat Pengantar RT/RW" data-src="/storage/files/request_business/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat Pengantar</a>
										@elseif ($request_doc->request_attachment_note == "FILE_KK")
											<label class="form-label">Kartu Keluarga</label><br>
											<a href="javascript:void(0)" data-title="Kartu Keluarga" data-src="/storage/files/request_business/kk/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Kartu Keluarga</a>
										@elseif ($request_doc->request_attachment_note == "FILE_USAHA")
											<label class="form-label">Foto Usaha</label><br>
											<a href="javascript:void(0)" data-title="Foto Usaha" data-src="/storage/files/request_business/usaha/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Foto Usaha</a>
										@elseif ($request_doc->request_attachment_note == "FILE_PERNYATAAN")
											<label class="form-label">Surat Pernyataan Memiliki Usaha</label><br>
											<a href="javascript:void(0)" data-title="Surat Pernyataan Memiliki Usaha" data-src="/storage/files/request_business/surat_pernyataan/{{$request_doc->request_attachment_file}}" class="btn btn-light btnStreamModal"><i class="ri-image-line me-2"></i> Surat Pernyataan Memiliki Usaha</a>
										@endif
									</p>
								</div>
							@endforeach
