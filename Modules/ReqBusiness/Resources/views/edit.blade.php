...
@section('content')
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-12">
            ...
            <p class="mb-0 text-muted">Surat Keterangan Mempunyai Usaha</p>
        </div>
    </div>
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/mempunyai-usaha/update/{{ $request->request_id }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select" name="id_status_kawin" disabled="disabled">
                    ...
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <!-- div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="masa_berlaku" class="form-control datepicker"
                                            placeholder="dd/mm/yyyy"
                                            value="{{ DateFormatHelper::dateNum($request_detail->masa_berlaku) }}">
                                        <span class="input-group-text" id="basic-addon2"><i
                                                class="ri-calendar-line"></i></span>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis_usaha" class="form-control"
                                        value="{{ $request_detail->jenis_usaha }}" placeholder="Masukan jenis usaha">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="npwp" class="form-control"
                                        value="{{ $request_detail->npwp }}"
                                        placeholder="Masukan nomor pokok wajib pajak">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label">Keperluan Kredit Ke-<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="kredit_ke" value="{{ $request_detail->kredit_ke }}"
                                        class="form-control" placeholder="Bank">
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label">Tanggal Surat Pernyataan<span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <input type="text" name="tgl_surat_pernyataan" class="form-control datepicker"
                                            value="{{ DateFormatHelper::dateNum($request_detail->tgl_surat_pernyataan) }}"
                                            placeholder="dd/mm/yyyy">
                                        <span class="input-group-text" id="basic-addon2"><i
                                                class="ri-calendar-line"></i></span>
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat_usaha" placeholder="Tulis alamat usaha disini">{{ $request_detail->alamat_usaha }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                                ...
                                <label class="form-label">Kartu Tanda Penduduk (KTP)<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                            <a href="/storage/files/request_business/ktp/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                ...
                                <label class="form-label">Kartu Keluarga<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KK')
                                            <a href="/storage/files/request_business/kk/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <label class="form-label">Surat Pengantar RT/RW<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                            <a href="/storage/files/request_business/pengantar_rt_rw/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Foto Usaha<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_USAHA')
                                            <a href="/storage/files/request_business/usaha/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <input type="file" name="f_usaha" class="form-control" placeholder="Masukan usaha">
                                <small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Surat Pernyataan Mempunyai Usaha<span
                                        class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_PERNYATAAN')
                                            <a href="/storage/files/request_business/surat_pernyataan/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <input type="file" name="f_pernyataan" class="form-control"
                                    placeholder="Masukan foto surat pernyataan">
                                <small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
                            </div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            form.validate({
                ...
                messages: {
                    no_surat_pengantar: "Surat pengantar tidak boleh kosong",
                    ...
                    kredit_ke: {
                        required: 'Keperluan kredit tidak boleh kosong'
                        // number: 'Harus berisi angka'
                    },
                    tgl_surat_pernyataan: "Tanggal surat tidak boleh kosong",
                    alamat_usaha: "Alamat tidak boleh kosong",
                    f_ktp: {
