...
namespace Modules\ReqHajj\Http\Controllers;
...
use Modules\ReqHajj\Repositories\HajjRepository;
...
class ReqHajjController extends Controller
{
    public function __construct(){
        ...
        $this->_hajjRepository              = new HajjRepository;
    ...
    public function create(Request $request)
    {
        ...
        return view('reqhajj::create',  compact('user', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->_hajjRepository->insert(DataHelper::_normalizeParams($request->all(), true));
        ...
        if($req_id != null){
            $data_email   = array(
                ...
                'url'           => env('APP_URL').'/user/layanan/ibadah-haji/lihat/'.$req_id,
                'service_name'  => 'Surat Keterangan Ibadah Haji',
    ...
    public function show(Request $request, $id)
    {
        ...
        $request_detail  = $this->_hajjRepository->getByParams($filter); 

        return view('reqhajj::detail', compact ('request', 'request_detail', 'logs', 'request_docs'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('reqhajj::edit', compact ('request', 'request_detail', 'logs', 'request_docs', 'sub_districts', 'districts', 'religions', 'genders', 'merried_stats', 'attach_samples'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->_hajjRepository->update(DataHelper::_normalizeParams($request->all(), false, true), $id);
    ...
    private function _uploadFile($request)
    {
        ...
        if ($request->file('f_ktp') != '') {
            ...
            $request->file("f_ktp")->storeAs('files/request_hajj/ktp', $imageName, 'public');
        ...
        if ($request->file('f_p_rt_rw') != '') {
            ...
            $request->file("f_p_rt_rw")->storeAs('files/request_hajj/pengantar_rt_rw', $imageName, 'public');
        ...
        if ($request->file('f_kk') != '') {
            ...
            $request->file("f_kk")->storeAs('files/request_hajj/kk', $imageName, 'public');
