...
namespace Modules\ReqNotHouse\Repositories;

use App\Implementations\QueryBuilderImplementation;
use Illuminate\Support\Facades\DB;

class ReqNotHouseRepository extends QueryBuilderImplementation
{

    protected $fillable = ['status_tinggal_skr', 'perihal', 'request_id', 'created_at', 'created_by', 'updated_at', 'updated_at'];

    public function __construct()
    {
        $this->table = 'req_ket_house';
        $this->pk = 'req_ket_house_id';
    }

    //overide
    public function insert(array $data)
    {
        $data['requests_det']['status_tinggal_skr'] = $data['status_tinggal_skr'];
