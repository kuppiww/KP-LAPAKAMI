...
@section('content')
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-12">
            ...
            <p class="mb-0 text-muted">Surat Keterangan Belum Memiliki Rumah</p>
        </div>
    </div>
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/belum-memiliki-rumah/update/{{$request->request_id}}"
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="perihal" class="form-control"
                                        value="{{ $request_detail->perihal }}" placeholder="Masukan keperluan">
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <label class="form-label">Status Tinggal Sekarang<span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="status_tinggal_skr" class="form-control"
                                        value="{{ $request_detail->status_tinggal_skr }}"
                                        placeholder="Masukan status tinggal sekarang">
                                </div>
                            </div>
                                ...
                                <label class="form-label">Kartu Tanda Penduduk (KTP)<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                            <a href="/storage/files/request_house/ktp/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                ...
                                <label class="form-label">Kartu Keluarga<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KK')
                                            <a href="/storage/files/request_house/kk/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <label class="form-label">Surat Pengantar RT/RW<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                            <a href="/storage/files/request_house/pengantar_rt_rw/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                ...
                                <label class="form-label"> Surat Pernyataan<span class="text-danger">*</span>
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_PERNYATAAN')
                                            <a href="/storage/files/request_house/surat_pernyataan/{{ $request_doc->request_attachment_file }}"
                                                target="_blank"
                                                class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            form.validate({
                ...
                messages: {
                    status_tinggal_skr: "Status tinggal tidak boleh kosong",
