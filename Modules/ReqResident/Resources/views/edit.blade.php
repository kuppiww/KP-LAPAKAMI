...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/penduduk/update/{{ $request->request_id }}"
                        ...
                        <div class="row">
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                            <a href="/storage/files/request_resident/ktp/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KK')
                                            <a href="/storage/files/request_resident/kk/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                            <a href="/storage/files/request_resident/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_PENDUKUNG')
                                            <a href="/storage/files/request_resident/pendukung/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                                </label>
                                <input type="file" name="f_pendukung" class="form-control"
    ...
    <script type="text/javascript">
        (function($) {
            ...
            form.validate({
                ...
                messages: {
                    kewarganegaraan: "Kewarganegaraan tidak boleh kosong",
                    id_status_kawin: "Status kawin harus dipilih",
