...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/penduduk/buat" enctype="multipart/form-data">
                @csrf
                <!-- Form 1 -->
                <h3>
                                    ...
                                    <select class="form-control form-select" name="id_status_kawin" disabled="disabled">
                                        ...
                                        @if (sizeof($merried_stats) > 0)
                                            @foreach ($merried_stats as $merried_stat)
                                                <option value="{{ $merried_stat->id_merried_status }}" {{ $user->id_merried_status == $merried_stat->id_merried_status ? 'selected' : ''}}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="file" name="f_pendukung" class="form-control"
                                    placeholder="Masukan dokumen perndukung">
                                <small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
                            </div>
