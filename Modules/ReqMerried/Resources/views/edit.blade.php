...
@section('content')
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-12">
            <h4 class="text-dark fw-bold mb-0">Perbaharui Permohonan Layanan</h4>
            <p class="mb-0 text-muted">Surat Keterangan Belum Menikah</p>
        </div>
    </div>
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/belum-menikah/update/{{ $request->request_id }}"
                    ...
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control form-select" disabled name="id_jenkel">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control form-select" name="id_agama" disabled>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pekerjaan" class="form-control"
                                        value="{{ $request->pekerjaan }}" disabled placeholder="Masukan pekerjaan">
                                </div>
                            </div>
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_KTP')
                                            <a href="/storage/files/request_merried/ktp/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">
                                    ...
                                    @if ($request_doc->request_attachment_note == 'FILE_KK')
                                        <a href="/storage/files/request_merried/kk/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                            <i class="ri-arrow-right-up-line"></i> Lihat File
                                        </a>
                                    @endif
                                    @endforeach
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_RT_RW')
                                            <a href="/storage/files/request_merried/pengantar_rt_rw/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_PERNYATAAN')
                                            <a href="/storage/files/request_merried/surat_pernyataan/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                                ...
                                <label class="form-label">
                                    ...
                                    @foreach ($request_docs as $request_doc)
                                        @if ($request_doc->request_attachment_note == 'FILE_AKTA_CERAI')
                                            <a href="/storage/files/request_merried/akta_cerai/{{$request_doc->request_attachment_file}}" target="_blank" class="bg-light ms-2 text-primary p-1 px-2 rounded-2 ms-2">
                                                <i class="ri-arrow-right-up-line"></i> Lihat File
                                            </a>
                                        @endif
                                    @endforeach
                                </label>
                                <input type="file" name="f_akta" class="form-control"
