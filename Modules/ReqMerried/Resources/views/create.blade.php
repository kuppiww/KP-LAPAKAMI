...
@section('content')
    ...
    <div class="card p-2 border-0">
        <div class="card-body">
            ...
            <form id="createForm" method="POST" action="/user/layanan/belum-menikah/buat" enctype="multipart/form-data">
				@csrf
                <!-- Form 1 -->
                <h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="text" name="tmp_lahir" class="form-control"
                                    placeholder="Masukan tempat lahir" value="{{ $user->user_tmp_lahir }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="text" name="pekerjaan" class="form-control" placeholder="Masukan pekerjaan" value="{{$user->user_pekerjaan}}" readonly>
                            </div>
                    ...
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="text" name="no_surat_pengantar" class="form-control" placeholder="Masukan nomor surat">
                            </div>
                            <div class="col-md-6 mb-3 form-group">
                ...
                <fieldset>
                    <div class="fieldset-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Surat Surat Pernyataan<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                <label class="form-label">Akta Cerai (Bagi yang menikah lagi)</label>
