		...
		<div class="col-md-4 h-100 bg-primary align-items-center d-none d-md-flex">
			<div class="mx-5">
				...
				<div class="mb-5 d-flex align-items-center">
					<a href="{{ env('PORTAL_URL').'/masyarakat/dashboard' }}" class="btn btn-lg btn-icon btn-white rounded-circle py-1 me-3">
						<i class="ri-arrow-left-line"></i>
					</a>
					<a href="{{ env('PORTAL_URL').'/masyarakat/dashboard' }}" class="text-white d-inline-block">Dashboard Masyarakat</a>
				</div>
				<!-- End Back Button -->
				...
				<!-- Footer -->
				<footer class="mt-5">
					<p class="mb-0 text-white"><small>Hak Cipta 2024 Lapakami<br>Pemerintah Daerah Kota Cimahi</small></p>
				</footer>
				<!-- End Footer -->
			</div>
		</div>
			...
			<div class="row justify-content-center align-items-center h-100 w-100 mx-0">
				<div class="col-md-10 col-11">
					...
					<div class="mb-4 mt-4 d-flex align-items-center position-absolute top-0 d-md-none">
						<a href="{{ env('PORTAL_URL').'/masyarakat/dashboard' }}" class="btn btn-lg btn-icon btn-primary rounded-circle py-1 me-3">
							<i class="ri-arrow-left-line"></i>
						</a>
						<a href="{{ env('PORTAL_URL').'/masyarakat/dashboard' }}" class="text-dark d-inline-block">Dashboard Masyarakat</a>
					</div>
