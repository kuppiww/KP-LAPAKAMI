...
@section('content')
    ...
    <div class="alert bg-warning">
        <h6 class="text-white fw-bold">
            Anda belum memiliki izin akses layanan ini. Untuk mendapatkan izin silahkan isi form terlebih dahulu
        </h6>
    </div>
    ...
    <form class="row mt-5" id="addForm" method="POST" action="{{ url('/daftar/store') }}">
        ...
        <input type="text" name="is_sso" value="true" hidden readonly>
        <div class="col-md-6 mb-3">
            <div class="form-group">
                <label class="form-label">Nomor Induk Kependudukan</label>
                <input type="text" name="user_nik" class="form-control" value="{{ $data['nik'] }}" placeholder="Masukan nomor induk kependudukan">
            </div>
        </div>
        <div class="col-md-6 mb-3">
            <div class="form-group">
        ...
        <div class="col-md-6 mb-3">
            <div class="form-group">
                ...
                <input type="text" name="user_nama" class="form-control" value="{{ $data['nama'] }}">
            </div>
        </div>
        <div class="col-md-6 mb-3">
            <div class="form-group">
                <label class="form-label">Email</label>
                <input type="text" name="user_email" class="form-control" value="{{ $data['email'] }}">
            </div>
        </div>
        {{-- <div class="col-md-6 mb-3">
            <div class="form-group">
        ...
        <div class="col-md-12 mt-4">
            <button type="submit" class="btn btn-primary px-4">Minta izin akses</button>
        </div>
    </form>
@endsection
