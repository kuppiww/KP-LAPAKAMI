...
<head>
	...
	<title>Lapakami Perubahan Email Pengguna</title>
...
<div class="background">
	<div class="container">
		...
		<div class="content">
			...
			<p>Perubahan email pada profil akun Lapakami berhasil dilakukan, silahkan untuk melakukan verifikasi email baru melalui tautan dibawah</p>
			<p style="margin-top: 30px;">
				<a href="{{$data['url']}}/user/activation/{{ $data['nik'] }}/{{ $data['token'] }}" class="button">Verifikasi Email</a>
			</p>
			<p style="margin-top: 30px;">
