...
<head>
	...
	<title>Lapakami Permohonan {{$data['status']}}</title>
...
<div class="background">
	<div class="container">
		...
		<header>
			<img src="{{env('APP_URL_LAPAKAMI')}}/assets/img/lapakami-logo-text.png" class="Lapakami" height="60px">
		</header>
		<div class="title">
			<h3>Permohonan Layanan ({{$data['status']}})</h3>
		</div>
		<div class="content">
		...
		<footer>
			<p>
				<small>Hak Cipta 2024. Lapakami</small> <br>
