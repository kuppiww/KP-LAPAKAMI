...
<div class="background">
	<div class="container">
		...
		<div class="title">
			<h3>Permohonan Layanan (Diajukan)</h3>
		</div>
		<div class="content">
			<p>Halo, <b>{{ $data['name'] }}</b></p>
			<p>Selamat permohonan layanan yang anda ajukan melalui aplikasi Lakami telah dikirim, proses permohonan dapat anda lihat melalui Lapakami menggunakan akun anda dengan detail permohonan sebagai berikut.</p>
