                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan kewarganegaraan">
						</div>
						<div class="col-md-6 mb-3 form-group">
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan nama yayasan/lembaga/organisasi">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Jenis Usaha<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan jenis usaha">
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Jumlah Anggota<span class="text-danger">*</span></label>
							<div class="input-group">
								<input type="text" name="" class="form-control" placeholder="Masukan jumlah karyawan">
						...
						<div class="col-md-6 mb-3 form-group">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan jam kerja">
						</div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Alamat Usaha<span class="text-danger">*</span></label>
							<textarea class="form-control" placeholder="Tulis alamat usaha disini"></textarea>
						</div>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Foto Akta Pendirian Yayasan/Lembaga/Organisasi<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan akta pendirian">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
						...
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Foto Sewa Penyewa/Bukti Kepemilikan Tempat<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto sewa">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 form-group">
							<label class="form-label">Foto Denah Lokasi</label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto denah lokasi">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
					</div>
				</div>
