                	...
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							...
							<select class="form-control form-select">
								...
								<option>Suami meninggal</option>
								<option>Istri meninggal</option>
							</select>
						</div>
						<div class="col-md-12 mb-3">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Keluarga<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Akta Cerai/Akta Kematian Suami/Istri<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto akta cerai">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Surat Dibawah Tangan/SPTJM (bagi pemohon untuk nikah siri)</label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto surat dibawah tangan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-12 mt-4"><h5>Format Berkas Pendukung</h5></div>
						<p class="text-muted">Format pendukung yang dapat anda unduh</p>
						<p><a href=""><i class="ri-file-download-line text-primary me-2"></i> Unduh SPTJM Nikah Siri</a></p>
					</div>
				</div>
