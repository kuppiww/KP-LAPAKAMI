            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-12 mt-4"><h5>Informasi Usaha</h5></div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan nomor pokok wajib pajak">
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Keperluan Kredit Ke-<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="0">
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Tanggal Surat Pernyataan<span class="text-danger">*</span></label>
							<div class="input-group">
								<input type="text" name="" class="form-control datepicker" placeholder="dd/mm/yyyy">
								<span class="input-group-text" id="basic-addon2"><i class="ri-calendar-line"></i></span>
							</div>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Keluarga (KK)<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KK">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="file" name="" class="form-control" placeholder="Masukan usaha">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Surat Pernyataan Mempunyai Usaha<span class="text-danger">*</span></label>
