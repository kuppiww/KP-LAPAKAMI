		...
		<form id="createForm" method="POST">
                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan nama pasangan">
						</div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Alamat Pasangan<span class="text-danger">*</span></label>
							<textarea class="form-control" placeholder="Tulis alamat pasangan disini"></textarea>
						</div>
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Tanda Penduduk (KTP) Calon Pengantin Pria/Wanita<span class="text-danger">*</span></label>
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Keluarga (KK) Calon Pengantin Pria/Wanita</label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
