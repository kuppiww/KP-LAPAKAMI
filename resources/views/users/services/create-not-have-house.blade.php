            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-12 mb-3">
							<label class="form-label">Status Tinggal Sekarang<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan status tinggal sekarang">
						</div>
