            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row align-items-center">
						...
						<!-- Activity -->
						<div class="col-md-12 mt-4"><h5>Informasi Kegiatan</h5></div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Nama Kegiatan<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan nama kegiatan">
						</div>
						<div class="col-md-6 mb-3">
							...
							<div class="form-check form-switch d-inline-block ms-2">
							  	...
							  	<label class="form-check-label" for="swithmoreday"><p class="mb-0"><small>Lebih dari 1 hari</small></p></label>
							</div>
							<div class="input-group">
								<input type="text" name="" class="form-control datepicker" placeholder="dd/mm/yyyy">
								<span class="input-group-text" id="basic-addon2"><i class="ri-calendar-line"></i></span>
						...
						<div class="col-md-6 mb-3 d-none" id="moreday">
