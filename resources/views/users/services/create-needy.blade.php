	...
	<div class="card-body">
		...
		<form id="createForm" method="POST">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
                		<div class="col-md-12 mt-4"><h5>Informasi Kebutuhan</h5></div>
                		<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3 d-none" id="otherForm">
							<label class="form-label">Keperluan<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan keperluan">
						</div>

						<!-- Student -->
						<div class="row mx-0 px-0 d-none" id="studentForm">
							<div class="col-md-12 mt-4"><h5>Informasi Siswa</h5></div>
	                		<div class="col-md-6 mb-3">
								<label class="form-label">Nomor Kartu Indonesia Pintar (KIP)<span class="text-danger">*</span></label>
								<input type="text" name="" class="form-control" placeholder="Masukan nomor KIP">
							</div>
							<div class="col-md-6 mb-3">
							...
							<div class="col-md-6 mb-3">
								...
								<input type="text" name="" class="form-control" placeholder="Masukan nama sekolah">
							</div>
							<div class="col-md-6 mb-3">
								<label class="form-label">Keperluan<span class="text-danger">*</span></label>
								<select class="form-control form-select">
									<option value="">- Pilih Keperluan -</option>
									<option>Keringanan Biaya Pendidikan</option>
									<option>Beasiswa Sekolah</option>
									<option>Pengbilan Ijazah Sekolah</option>
									<option>Bantuan Walikota</option>
								</select>
							</div>
						</div>
						<!-- End Student -->
						...
						<div class="row mx-0 px-0 d-none" id="patientForm">
							<div class="col-md-12 mt-4"><h5>Informasi Pasien</h5></div>
	                		<div class="col-md-6 mb-3">
								<label class="form-label">Nomor Kartu Indonesia Pintar (KIP)<span class="text-danger">*</span></label>
								<input type="text" name="" class="form-control" placeholder="Masukan nomor KIP">
							</div>
							...
							<div class="col-md-6 mb-3">
								<label class="form-label">Nomor Jamkesmas<span class="text-danger">*</span></label>
								<input type="text" name="" class="form-control" placeholder="Masukan nomor jamkesmas">
							</div>
							<div class="col-md-6 mb-3">
								<label class="form-label">Nama Rumah Sakit<span class="text-danger">*</span></label>
								<input type="text" name="" class="form-control" placeholder="Masukan nama rumah sakit">
							</div>
						</div>
						<!-- End Patient -->
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Surat Pernyataan<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto surat pernyataan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 d-none" id="schoolRequirement">
							<label class="form-label">Foto Surat Rekomendasi Sekolah<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto surat rekomendasi">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 d-none" id="referenceRequirement">
							<label class="form-label">Foto Surat Rujukan Puskesmas/Rumah Sakit<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto surat rujukan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3 d-none" id="cardRequirement">
							<label class="form-label">Foto Kartu Jamkesmas</label>
							<input type="file" name="" class="form-control" placeholder="Masukan kartu jamkesmas">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-12 mt-4"><h5>Format Berkas Pendukung</h5></div>
						<p class="text-muted">Format pendukung yang dapat anda unduh</p>
						<p><a href=""><i class="ri-file-download-line text-primary me-2"></i> Unduh Surat Penyataan</a></p>
					</div>
				</div>
