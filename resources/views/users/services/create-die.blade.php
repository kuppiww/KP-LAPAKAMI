            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-12 mt-4"><h5>Informasi Meninggal</h5></div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan lokasi">
						</div>
						<div class="col-md-3 mb-3">
							<label class="form-label">Usia Saat Meninggal<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan usia">
						</div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Penyebab Meninggal<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan penyebab">
						</div>
						<div class="col-md-12 mb-3">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Tanda Penduduk (KTP) Yang Meninggal<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Keluarga (KK) Yang Meninggal<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KK">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Tanda Penduduk (KTP) Pelapor<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Tanda Penduduk (KTP) Saksi 1<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Kartu Tanda Penduduk (KTP) Saksi 2<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Buku Nikah Hal 1-3 (jika sudah menikah)</label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto KTP">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
					</div>
