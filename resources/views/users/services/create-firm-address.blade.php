                ...
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-12 mb-3">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan nama perusahaan">
						</div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" name="" class="form-control" placeholder="Masukan notaris">
						</div>
						<div class="col-md-6 mb-3">
							<label class="form-label">No. Akta Notaris<span class="text-danger">*</span></label>
							<input type="text" name="" class="form-control" placeholder="Masukan nomor akta notaris">
						</div>
						<div class="col-md-6 mb-3">
            ...
            <fieldset>
                <div class="fieldset-content">
                	<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Akta Pendirian Perusahaan/Akta Notaris Perusahaan<span class="text-danger">*</span></label>
							<input type="file" name="" class="form-control" placeholder="Masukan akta pendirian perusahaan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
						<div class="col-md-6 mb-3">
						...
						<div class="col-md-6 mb-3">
							<label class="form-label">Foto Surat Keterangan Tidak Keberatan Tanah/Rumah Dipakai Usaha</label>
							<input type="file" name="" class="form-control" placeholder="Masukan foto surat keterangan tidak keberatan">
							<small class="form-note">File .jpg, .jpeg, .png, .pdf, Maksimal 1MB</small>
						</div>
					</div>
				</div>
